...
_EPC_MOA_TO_MOA: List[Tuple[str, str]] = [
    ...
    ("esomeprazole",                                        "H_K_ATPase_INHIBITION"),
    ("omeprazole",                                          "H_K_ATPase_INHIBITION"),
    ("pantoprazole",                                        "H_K_ATPase_INHIBITION"),
    ("lansoprazole",                                        "H_K_ATPase_INHIBITION"),
    ("rabeprazole",                                         "H_K_ATPase_INHIBITION"),
    ("dexlansoprazole",                                     "H_K_ATPase_INHIBITION"),
...
_FREETEXT_CLASS_PATTERNS: List[Tuple[str, str]] = [
    ...
    (r"proton pump inhibit|h\+/k\+.atpase|\bprazole\b|esomeprazole|omeprazole|pantoprazole|lansoprazole|rabeprazole", "PPI"),
...
_FREETEXT_MOA_PATTERNS: List[Tuple[str, str]] = [
    ...
    (r"proton pump inhibit|h\+/k\+.atpase|\bprazole\b|esomeprazole|omeprazole|pantoprazole|lansoprazole|rabeprazole", "H_K_ATPase_INHIBITION"),
